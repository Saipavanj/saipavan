...
Original file is located at
    https://colab.research.google.com/drive/1y4qVZT6wXHz1ktu8alNpMpTnlIgh62kW
"""
...
data1=pd.read_excel("/content/MELBOURNE_HOUSE_PRICES_LESS.xlsx")

data2=pd.read_excel("/content/Melbourne_housing_FULL.xlsx")
...
cols_to_convert=['Suburb','Address','Type','Method','SellerG','Date','Regionname','CouncilArea']

data=data.drop(["Date"],axis=1)

labels_dict = {}
cols_to_convert = []  # add the names of the columns you want to convert
